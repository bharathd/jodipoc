                ...
                <div className="container">
					...
					<div className="row">
							 ...
							 <h4 className="title">Search for a Better Profile</h4> 
								...
								<div className="row">
								 ...
								 <input type="email" name="email" className="home-form" placeholder="Phone Number" required /> 
									...
									<div className="col-sm-12">
										<input type="checkbox"/> <a href="https://jodibanao.in/beta/" style={{fontweight: '500'}} className="label-checkbx-names">I accept your Terms and Conditions</a><br/><br/>
									</div>
									<div className="clearfix"></div>
									<div className="col-sm-12">
						...
						<div className="col-sm-6 order-sm-3 order-1">
							...
							<div className="parallax-elemen" id="stuff" style={{transform: "translate3d(0px, 0px, 0px) rotate(0.0001deg)", transformstyle: 'preserve-3d', backfacevisibility: 'hidden', pointerevents: 'none'}}>
								<span data-depth="0.5" style={{transform: "translate3d(5.9px, 2.4px, 0px)", transformstyle: 'preserve-3d', backfacevisibility: 'hidden', position: 'relative', display: 'block', left: '0px', top: '0px'}}><img className="wow animate slideInLeft" src={img1} alt="" style={{visibility: 'visible', animationname: 'slideInLeft'}}/></span>
								<span data-depth="0.4" style={{transform: "translate3d(4.8px, 1.9px, 0px)", transformstyle: 'preserve-3d', backfacevisibility: 'hidden', position: 'absolute', display: 'block', left: '0px', top: '0px'}}><img className="wow animate slideInRight" data-wow-delay="100ms" src={img2} alt="" style={{visibility: 'visible', animationdelay: '100ms', animationname: 'slideInRight'}}/></span>
								<span data-depth="0.6" style={{transform: "translate3d(7.1px, 2.9px, 0px)", transformstyle: 'preserve-3d', backfacevisibility: 'hidden', position: 'absolute', display: 'block', left: '0px', top: '0px'}}><img className="wow animate slideInRight" data-wow-delay="500ms" src={img3} alt="" style={{visibility: 'visible', animationdelay: '500ms', animationname: 'slideInRight'}}/></span>
								<span data-depth="1.2" style={{transform: "translate3d(14.3px, 5.8px, 0px)", transformstyle: 'preserve-3d', backfacevisibility: 'hidden', position: 'absolute', display: 'block', left: '0px', top: '0px'}}><img className="wow animate slideInLeft" data-wow-delay="400ms" src={img4} alt="" style={{visibility: 'visible', animationdelay: '400ms', animationname: 'slideInLeft'}}/></span>
								<span data-depth="1" style={{transform: "translate3d(11.9px, 4.8px, 0px)", transformstyle: 'preserve-3d', backfacevisibility: 'hidden', position: 'absolute', display: 'block', left: '0px', top: '0px'}}><img className="wow animate slideInLeft" data-wow-delay="200ms" src={img5} alt="" style={{visibility: 'visible', animationdelay: '200ms', animationname: 'slideInLeft'}}/></span>
								<span data-depth="0.8" style={{transform: "translate3d(9.5px, 3.8px, 0px)", transformstyle: 'preserve-3d', backfacevisibility: 'hidden', position: 'absolute', display: 'block', left: '0px', top: '0px'}}><img className="wow animate slideInRight" data-wow-delay="300ms" src={img6} alt="" style={{visibility: 'visible', animationdelay: '300ms', animationname: 'slideInRight'}}/></span>

								<div data-depth="0.3" style={{transform: "translate3d(3.6px, 1.4px, 0px)", transformstyle: 'preserve-3d', backfacevisibility: 'hidden', position: 'absolute', display: 'block', left: '0px', top: '0px'}}><img src={h7bnrlyr} alt=""/></div>
							</div>
						</div>
					</div>
                </div>
